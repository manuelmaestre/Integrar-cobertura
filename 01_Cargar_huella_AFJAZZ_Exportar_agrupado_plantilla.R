...
fichero.report.AF <- './data/clean/huella_acceso_fibra_JAZZ.txt'
...
accesofibra.file <- lista.into.zip[str_sub(lista.into.zip$Name,1,10) == 'BT_029_904', c("Name")]
...
direcciones.AF[, 'tipo.huella':= 'AccesoFibra_JAZZ']
...
direcciones.AF[,.(suma.UUII = sum(UUII), suma.accesos = sum(accesos))]
