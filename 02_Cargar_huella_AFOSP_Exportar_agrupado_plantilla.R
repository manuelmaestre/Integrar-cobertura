...
fichero.report.AF <- './data/clean/huella_acceso_fibra_OSP.txt'
...
accesofibra.file <- lista.into.zip[str_sub(lista.into.zip$Name,1,10) == 'BT_030_904', c("Name")]
...
direcciones.AF[, 'tipo.huella':= 'AccesoFibra_OSP']
